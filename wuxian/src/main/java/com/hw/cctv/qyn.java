...
//        String httplink="https://www.michelin.com.cn/_api/dealer-locator/getDealerByCitySortedByDistance.php?city=%E8%8B%8F%E5%B7%9E&longitude=120.61990712&latitude=31.31798737&_=1575599987684";  //苏州
        for(int i=1;i<=349;i++)
        {
            ...
            try {
                ...
                URIBuilder uriBuilder = new URIBuilder("http://sj.cs.abqb.press/?m=vod-detail-id-43059.html&f112f=ff-uuzhiwei&name=eof9-");
                ...
                List<Element> links = document.getElementsByClass("mlist scroll");
